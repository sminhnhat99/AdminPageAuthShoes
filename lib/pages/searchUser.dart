...
class _SearchUserPageState extends State<SearchUserPage> {
  ...
  void initState(){
    ...
    print(this.widget.userId.runtimeType);
  ...
  Widget _fetchUserData(){
    return FutureBuilder<SearchUser>(
      future: apiService.searchUser(sharetoken, this.widget.userId),
      builder: (BuildContext context, AsyncSnapshot<SearchUser> snapshot){
        if(snapshot.hasData){
          return _showFindUser(snapshot.data);
        }
        return Center(
  ...
  Widget _showFindUser(SearchUser searchUser){
          ...
          Card(
            child: Column(
                ...
                children: [
                  ListTile(
                    title: Text(
                      'User name:' + ' ' + searchUser.data.userName,
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        onPressed: (){
                          apiService.deleteUser(sharetoken, searchUser.data.id).then((value) => {
                            if(value.success == 1){
                              setState((){
